...
namespace Music_Notes
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            pi_10.Text = CalculatePi(996);
            transformNotes(pi_10.Text);
        }

        private void transformNotes(string notes)
        {
            char[] notesS = notes.ToCharArray();

            foreach(var noteL in notesS)
            {
                if (noteL != '.')
                {
        ...
        public static string CalculatePi(int digits)
        {
            ...
            string res10 = result.Remove(0, 1);
            result = "3." + res10;
            return result;
        }
    }
